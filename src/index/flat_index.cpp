...
//
//    template <typename T>
//    void FlatIndex<T>::build(const idx_t &dims, const std::string& path, const std::string& initial_data_path, const T* initial_data, const uint64_t& initial_data_size, const NamedArgs* args) {
//        this->dims_ = dims;
...
//    }
//
//     template class FlatIndex<int8_t>;
//     template class FlatIndex<int16_t>;
//     template class FlatIndex<int32_t>;
//     template class FlatIndex<int64_t>;
//     template class FlatIndex<uint8_t>;
//     template class FlatIndex<uint16_t>;
//     template class FlatIndex<uint32_t>;
//     template class FlatIndex<uint64_t>;
//     template class FlatIndex<float>;
//     template class FlatIndex<double>;
//}