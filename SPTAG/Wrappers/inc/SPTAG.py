...
class AnnIndex(object):
    ...
    def GetIterator(self, p_target):
        return _SPTAG.AnnIndex_GetIterator(self, p_target)
...
class ResultIterator(object):
    ...
    def __init__(self, p_index, p_target, p_searchDeleted, p_workspaceBatch):
        _SPTAG.ResultIterator_swiginit(self, _SPTAG.new_ResultIterator(p_index, p_target, p_searchDeleted, p_workspaceBatch))
    __swig_destroy__ = _SPTAG.delete_ResultIterator

    def GetWorkSpace(self):
        return _SPTAG.ResultIterator_GetWorkSpace(self)

    def Next(self, batch):
        return _SPTAG.ResultIterator_Next(self, batch)

    def GetRelaxedMono(self):
        return _SPTAG.ResultIterator_GetRelaxedMono(self)

    def Close(self):
        return _SPTAG.ResultIterator_Close(self)

    def GetTarget(self):
        return _SPTAG.ResultIterator_GetTarget(self)

# Register ResultIterator in _SPTAG:
_SPTAG.ResultIterator_swigregister(ResultIterator)
