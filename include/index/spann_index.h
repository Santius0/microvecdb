...
namespace mvdb::index {
    ...
    public:
        ...
        void build(const idx_t &dims, const std::string& path, const std::string& initial_data_path, const T* initial_data, idx_t* ids, const uint64_t& initial_data_size, const NamedArgs* args) override;
