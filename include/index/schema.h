...
//
//
//    struct Schema final : public Serializable {
//        AttributeSchema attribute_schema_ = {};
//        Schema() = default;
//        Schema(const std::vector<std::pair<std::string, std::type_index>>& attribute_list) {
//            for (const auto& attribute : attribute_list) {
//                attribute_schema_.insert(attribute);
//            }
//        }
//        Schema(const AttributeSchema& attributeSchema): attribute_schema_(attributeSchema) {}
//        ~Schema() = default;
//
